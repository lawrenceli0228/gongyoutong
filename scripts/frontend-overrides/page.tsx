...
function BootScreen() {
  return (
    ...
    >
      ...
      <div className="flex h-14 w-14 items-center justify-center rounded-[16px] bg-[#0E9F6E] text-[26px] font-black text-white shadow-[0_10px_30px_rgba(14,159,110,0.28)]">
        工
      </div>

      <div className="flex flex-col items-center gap-2">
        <div className="text-[17px] font-black tracking-tight text-[#1B2420]">
          工友通
        </div>
        {/* 说人话,并且**说清在等什么** —— 「載入中」三个字回答不了「还要多久 / 卡住了吗」。
            对比度:#626D68 在 #EEF1F0 上是 4.73:1,过 AA(与 GytStatusCards 同一个灰)。 */}
        <div className="text-[13px] font-medium text-[#626D68]">
          正在打開你的對話記錄…
        </div>
      </div>
      ...
      <div className="h-1 w-[132px] overflow-hidden rounded-full bg-[#DCE3E0]">
        <span className="block h-full w-1/3 rounded-full bg-[#0E9F6E] motion-safe:animate-[gyt-boot_1.1s_ease-in-out_infinite] motion-reduce:w-full motion-reduce:opacity-40" />
      </div>
